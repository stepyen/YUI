package com.stepyen.yui.radiogruop;
...
/**
 *
 * github：https://github.com/worker8/RadioGroupPlus/blob/master/radiogroupplus/src/main/java/worker8/com/github/radiogroupplus/RadioGroupPlus.java
 *
 ...
 *
 */
public class YRadioGroupPlus extends LinearLayout {
     ...
     * {@inheritDoc}
     */
    public YRadioGroupPlus(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public YRadioGroupPlus(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.YRadioGroupPlus);

        int value = ta.getResourceId(R.styleable.YRadioGroupPlus_rgp_checkedButton, View.NO_ID);
        if (value != View.NO_ID) {
            mCheckedId = value;
        }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(YRadioGroupPlus group, @IdRes int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View parent, View child) {
            traverseTree(child);
            if (parent == YRadioGroupPlus.this && child instanceof RadioButton) {
                int id = child.getId();
                // generates an id if it's missing
                if (id == View.NO_ID) {
                    id = View.generateViewId();
